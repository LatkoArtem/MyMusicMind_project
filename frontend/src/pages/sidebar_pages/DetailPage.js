...
const DetailPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchAllData = async () => {
      try {
        resetState();
        const detailsRes = await axios.get(`https://mymusicmind-backend.onrender.com/${type}/${id}`, {
        ...
        if (type === "albums") {
          tracksRes = await axios.get(`https://mymusicmind-backend.onrender.com/${type}/${id}/tracks`, {
            withCredentials: true,
            signal: controller.signal,
          });
          if (!isMounted) return;
          ...
          setIsAnalyzing(true);
          const analysisRes = await axios.get(`https://mymusicmind-backend.onrender.com/analyze_album/${id}`, {
            withCredentials: true,
            signal: controller.signal,
          });
          if (!isMounted) return;
          ...
          setIsAnalyzing(true);
          const analysisRes = await axios.get(`https://mymusicmind-backend.onrender.com/analyze_playlist/${id}`, {
            withCredentials: true,
            signal: controller.signal,
          });
          if (!isMounted) return;
          ...
          tracksRes = await axios.get(`https://mymusicmind-backend.onrender.com/${type}/${id}/top-tracks`, {
            withCredentials: true,
            signal: controller.signal,
          });
          if (!isMounted) return;
          ...
          const similarRes = await axios.get(
            `https://mymusicmind-backend.onrender.com/similar_artists/${detailsRes.data.name}`,
            {
              withCredentials: true,
              signal: controller.signal,
            }
          ...
          const detailsResPodcast = await axios.get(`https://mymusicmind-backend.onrender.com/podcasts/${id}`, {
            withCredentials: true,
            signal: controller.signal,
          });
          if (!isMounted) return;
          ...
          tracksRes = await axios.get(`https://mymusicmind-backend.onrender.com/podcasts/${id}/episodes`, {
            withCredentials: true,
            signal: controller.signal,
          });
          if (!isMounted) return;
