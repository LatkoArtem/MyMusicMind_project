...
const DetailPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchAllData = async () => {
      try {
        resetState();
        const detailsRes = await axios.get(`/api/${type}/${id}`, {
        ...
        if (type === "albums") {
          tracksRes = await axios.get(`/api/${type}/${id}/tracks`, {
            withCredentials: true,
            signal: controller.signal,
          });
          if (!isMounted) return;
          ...
          setIsAnalyzing(true);
          const analysisRes = await axios.get(`/api/analyze_album/${id}`, {
            withCredentials: true,
            signal: controller.signal,
          });
          if (!isMounted) return;
          ...
          setIsAnalyzing(true);
          const analysisRes = await axios.get(`/api/analyze_playlist/${id}`, {
            withCredentials: true,
            signal: controller.signal,
          });
          if (!isMounted) return;
          ...
          tracksRes = await axios.get(`/api/${type}/${id}/top-tracks`, {
            withCredentials: true,
            signal: controller.signal,
          });
          if (!isMounted) return;
          ...
          const similarRes = await axios.get(`/api/similar_artists/${detailsRes.data.name}`, {
            withCredentials: true,
            signal: controller.signal,
          });
          if (!isMounted) return;
          ...
          const detailsResPodcast = await axios.get(`/api/podcasts/${id}`, {
            withCredentials: true,
            signal: controller.signal,
          });
          if (!isMounted) return;
          ...
          tracksRes = await axios.get(`/api/podcasts/${id}/episodes`, {
            withCredentials: true,
            signal: controller.signal,
          });
          if (!isMounted) return;
