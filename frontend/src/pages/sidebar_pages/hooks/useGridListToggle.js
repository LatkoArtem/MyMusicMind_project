...
const useViewMode = () => {
  ...
  useEffect(() => {
    axios
      .get("https://mymusicmind-backend.onrender.com/profile", { withCredentials: true })
      .then((res) => {
  ...
  const changeViewMode = (mode) => {
    setViewMode(mode);
    axios
      .post("https://mymusicmind-backend.onrender.com/viewmode", { viewMode: mode }, { withCredentials: true })
